...
class start_window:
    def __init__(self,start):
        ...
        image_path = os.path.join(base_folder, 'tic-tac-toe.png')
        self.starticon = PhotoImage(file=image_path)
...
""" 
عمل الطلاب 
1- محمد محمد محمد نعمان الغريب
2- رزان عماد الدين حسين احمد
3-ندى وائل يوسف العادلى
4-احمد عبد المحسن حسنى محمد
"""